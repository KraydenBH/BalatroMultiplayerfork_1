...
return {
	...
	misc = {
		...
		dictionary = {
			...
			b_opts_start_antes = "Стартовое анте",
			...
			b_opts_normal_bosses = "Включить эффект босс блайндов",
			b_reset = "Сбросить",
			...
			b_the_order_integration = "Включить The Order Integration",
			b_players = "Игроки",
			...
			k_in_lobby = "В лобби",
			k_connected = "Подключено к серверу",
			k_warn_service = "ПРЕДУПРЕЖДЕНИЕ: Не удалось подключится к серверу",
			k_warning_cheating = "Если вы видите это сообщение, возможно, ваш оппонент жульничает. Если это рейтинговая игра, пожалуйста, отправьте сообщение '%s', а затем откройте запрос в службу поддержки в разделе #support",
			...
			k_opts_pvp_start_round = "PVP начнётся на Анте",
			...
			k_the_order_integration_desc = "Этот патч позволяет изменить порядок выпадения карт, чтобы они не зависели от Анте",
			k_requires_restart = "*Нужна перезагрузка игры",
			k_bans = "Ограничения",
			k_reworks = "Изменения",		
		...
		v_dictionary = {
			...
			k_banned_objs = "Запрещены #1#",
			k_no_banned_objs = "Не запрещены #1#",
			k_reworked_objs = "Изменены #1#",
			k_no_reworked_objs = "Не изменены #1#",
		},
		v_text = {
